...
<head>
	...
	<title>웹 개발자 포트폴리오 | 포트폴리오 수정</title>
</head>
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<form action="/portfolios/modify" id="form" method="post" enctype="multipart/form-data">
					<div class="row">
						...
						<div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-8">
							<input type="text" id="title" name="title" class="form-control" value="${ view.title }" maxlength="50">
						</div>
					</div>
					<div class="form-group text-right">
						<textarea id="simpleContent" name="simpleContent" class="form-control" style="resize: vertical;">${ view.simpleContent }</textarea>
					</div>
					<div class="form-group text-right">
					...
					<div class="form-group">
						<div class="input-group text-right">
							<input type="text" class="form-control" id="file_name" disabled="disabled" value="${ view.image }">
					...
					<div class="form-group row">
						<div class="col-xs-12 text-right">
							<input type="hidden" id="pfNumber" name="pfNumber" value="${ view.pfNumber }">
	...
	<script src="/resources/js/portfolio/portfolio_modify.js"></script>
