...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<form action="/skills/modify" id="form" method="post">
					<div class="row">
						...
						<div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-8">
							<input type="text" id="subCategory" name="subCategory" class="form-control" value="${ view.subCategory }" maxlength="50">
						</div>
					</div>
					...
					<div class="form-group row">
						<div class="col-xs-12 text-right">
							<input type="hidden" id="skNumber" name="skNumber" value="${ view.skNumber }">
	...
	<script src="/resources/js/skills/skills_modify.js"></script>
